        ...
        errors: [
          {
            code: 0,
            message:
              '{"ValidationErrors":[{"Code":2,"Message":"Invalid value, must be in range [0.9 - 1.05]","FieldName":"Height","FieldData":""},{"Code":2,"Message":"Invalid value, must be in range [0.7 - 1]","FieldName":"Width","FieldData":""},{"Code":2,"Message":"Invalid value, must be in range [0.95 - 1]","FieldName":"Head","FieldData":""}]}',
          },
        ],
      })),
      [
